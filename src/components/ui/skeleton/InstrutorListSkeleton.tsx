...
interface InstrutorListSkeletonProps {
  rows?: number;
  showAvatar?: boolean;
  showActions?: boolean;
}
...
/**
 * Componente de skeleton loading para listagem de instrutores
 * 
 ...
 */
export function InstrutorListSkeleton({
  rows = 10,
  showAvatar = true,
  showActions = true,
}: InstrutorListSkeletonProps) {
  return (
