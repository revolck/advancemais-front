...
interface EditarAlunoEnderecoModalProps {
  isOpen: boolean;
...
export function EditarAlunoEnderecoModal({
  isOpen,
  onOpenChange,
  aluno,
  onConfirm,
}: EditarAlunoEnderecoModalProps) {
  const first = aluno.enderecos?.[0];
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      console.error("Erro ao atualizar endereço do aluno", error);
      toastCustom.error({
