    ...
    <div className={cn("min-h-full space-y-4", className)}>
      ...
      <div className="mb-4 flex flex-col items-stretch gap-3 sm:mb-2 sm:flex-row sm:items-center sm:justify-end">
        <ButtonCustom
          ...
          asChild
        >
          <Link href="/dashboard/cursos/aulas/cadastrar">Nova Aula</Link>
        </ButtonCustom>
      </div>
      ...
      {showEmptyState && (
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          <EmptyState
            ...
            description={
              selectedTurmaId
                ? "Nenhuma aula encontrada para os filtros aplicados. Tente ajustar sua busca."
