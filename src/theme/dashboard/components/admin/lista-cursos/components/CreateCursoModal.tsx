...
export function CreateCursoModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (fileItem?.file) {
        try {
          if (process.env.NODE_ENV === "development") {
            console.log("[CreateCursoModal] Iniciando upload da imagem...");
          }
          ...
          if (process.env.NODE_ENV === "development") {
            console.log("[CreateCursoModal] Upload concluído. URL:", finalImageUrl);
          }
          ...
          if (process.env.NODE_ENV === "development") {
            console.error("[CreateCursoModal] Erro no upload:", uploadError);
          }
      ...
      if (process.env.NODE_ENV === "development") {
        console.log("[CreateCursoModal] Payload completo sendo enviado:", payload);
        console.log("[CreateCursoModal] imagemUrl no payload:", payload.imagemUrl);
      }
