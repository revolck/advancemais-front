...
import {
  createEntrevista,
  listEntrevistaCandidatosOptions,
  listEntrevistaEmpresasOptions,
  listEntrevistaVagasOptions,
  type EntrevistaCandidatoOpcaoItem,
  type EntrevistaCreatePayload,
  type EntrevistaEndereco,
  type EntrevistaEmpresaOpcaoItem,
  type EntrevistaModalidade,
  type EntrevistaOverviewCapabilities,
  type EntrevistaVagaOpcaoItem,
...
export function AddEntrevistaModal({
  isOpen,
  onOpenChange,
  capabilities,
}: AddEntrevistaModalProps) {
  ...
  const empresasQuery = useQuery({
    queryKey: ["entrevistas-opcoes-empresas"],
    queryFn: () => listEntrevistaEmpresasOptions(),
    enabled: isOpen,
    staleTime: 5 * 60 * 1000,
  ...
  const vagasQuery = useQuery({
    queryKey: ["entrevistas-opcoes-vagas", formValues.empresaUsuarioId],
    queryFn: () =>
      listEntrevistaVagasOptions(formValues.empresaUsuarioId as string),
  ...
  const candidatosQuery = useQuery({
    queryKey: ["entrevistas-opcoes-candidatos", formValues.vagaId],
    queryFn: () => listEntrevistaCandidatosOptions(formValues.vagaId as string),
  ...
  const createMutation = useMutation({
    mutationFn: (payload: EntrevistaCreatePayload) => createEntrevista(payload),
...
export default AddEntrevistaModal;
