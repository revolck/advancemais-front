      ...
      },
      {
        ...
        submenu: [
          ...
          },
          {
            icon: null,
            label: "Notas",
            route: "/dashboard/cursos/alunos/notas",
            permissions: [UserRole.ALUNO_CANDIDATO],
          },
          {
            icon: null,
            label: "Frequência",
            route: "/dashboard/cursos/alunos/frequencia",
            permissions: [UserRole.ALUNO_CANDIDATO],
          },
          {
            icon: null,
            label: "Certificados",
            route: "/dashboard/cursos/alunos/certificados",
            permissions: [UserRole.ALUNO_CANDIDATO],
          },
          {
            icon: null,
            label: "Estágios",
            route: "/dashboard/cursos/alunos/estagios",
            permissions: [UserRole.ALUNO_CANDIDATO],
          },
        ],
      },
